...
const PollSystem = ({ user }) => {
  ...
  const fetchPolls = async () => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/polls?societyId=${encodeURIComponent(user.societyId)}`);
  ...
  const createPoll = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/polls/create`, {
        method: 'POST',
  ...
  const deletePoll = async (pollId) => {
    try {
      const response = await axios.delete(`${import.meta.env.VITE_API_URL}/api/polls/${pollId}`);
